---
title: 'React는 왜 `<script>` 태그를 실행하지 않을까? (feat. TanStack Router 오픈소스 기여)'
summary: 'React의 script 태그 실행 제약을 이해하고, TanStack Router 오픈소스 기여를 통해 SSR 환경까지 고려한 해결책을 구현한 과정'
date: '2026-01-10'
